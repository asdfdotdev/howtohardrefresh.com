...
export function Footer() {
  return (
    <footer
      className="'font-body flex flex-col items-center gap-2 text-center text-sm/6 md:order-1 md:mt-0 md:flex-row lg:mt-8'"
      role="contentinfo"
    >
      <span>
        <span className="inline-block [transform:scaleX(-1)]">&copy;</span> 2017-
        {new Date().getFullYear()}
      </span>
      <span className="hidden md:inline"> | </span>
      <span className="flex flex-row items-center">
        From your friends at
        <a href="https://asdf.dev" target="_blank" rel="noopener noreferrer" className="group ml-2 inline-flex">
          <span className="sr-only">howtohardrefresh.com is brought to you by asdf.dev</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="50" viewBox="0 0 594 205">
            <title>asdf.dev logo</title>
            <g fill="none" transform="translate(.5 .25)">
              ...
              <path
                fill="#000"
                d="M397.25,180.75 L397.25,67.5 L382.75,67.5 L382.75,50.75 L397.25,50.75 L397.25,44 C397.25,11.25 417,0.75 438,0.75 C442.25,0.75 446.25,1.25 446.25,1.25 L446.25,18.5 C446.25,18.5 443,18 440,18 C425.25,18 417.25,26 417.25,44 L417.25,50.75 L445,50.75 L445,67.5 L417.25,67.5 L417.25,180.75 L397.25,180.75 Z"
              ></path>
              <polygon
                points="458 188 593 188 593 204.5 458 204.5"
                className="cursor fill-zinc-950 transition-all duration-300 group-hover:fill-accent-primary"
              ></polygon>
            </g>
          </svg>
        </a>
