...
export const Head = () => (
  <Seo
    title="About | How to Hard Refresh"
    description="Get to know How to Hard Refresh"
    pathname="/about/"
  />
)
...
<Static>
  ...
  HowToHardRefresh.com is not affiliated in any way with Apple Inc., Microsoft Corporation, Opera Software AS,
